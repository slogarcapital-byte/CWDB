...
- [State-Agency Arbitration Rule](state-agency-arbitration-rule.md) — 2026-07-08: WI state agencies (UWSP, job CWDB-2026-044, $7,751) cannot agree to binding arbitration; strike 13.2, keep 13.1/13.3, fix venue cross-ref; venue vs. state = Dane County
- [Contractor Paper Cleanup 2026-07](contractor-paper-cleanup-2026-07.md) — 2026-07-22 DRAFTS: mutual terminations of both LPAs at $0 killing the 12-mo tail (Barton, Garcia) + James signs personally; Subcontractor Agreement v1 (Master + Exhibit A Work Order, CWDB Job Number) for Ben/John before Winchester (Aug 17-21); cover note + 10 Qs for Yde
- [Oral Notice Acknowledgment](../../docs/legal/oral-notice-acknowledgment.md) — 2026-07-22: one-line sentence for combined estimate+work-order acceptance block acknowledging ORAL disclosure of 3-day cancel right (16 CFR 429.1(a) + Wis. Stat. 423.203); own initial tab; cwdb lane only
