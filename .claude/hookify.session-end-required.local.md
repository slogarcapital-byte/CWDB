...
3. The skill will also write the dated state-archive snapshot at `_vault/state-archive/state-<sessionId>.md` (historical record; not source of truth — Supabase warehouse is).
